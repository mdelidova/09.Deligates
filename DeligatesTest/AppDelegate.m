...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MDPatient* patient1 = [[MDPatient alloc] init];
    patient1.name = @"Vova";
    patient1.temperature = 36.6f;
    
    MDPatient* patient2 = [[MDPatient alloc] init];
    patient2.name = @"Petya";
    patient2.temperature = 40.2f;
    
    MDPatient* patient3 = [[MDPatient alloc] init];
    patient3.name = @"Dima";
    patient3.temperature = 37.1f;
    
    MDPatient* patient4 = [[MDPatient alloc] init];
    patient4.name = @"Kolya";
    patient4.temperature = 38.9f;
    
    MDDoctor* doctor = [[MDDoctor alloc] init];
